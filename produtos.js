...
function loadProdutos() {
  ...
  for (var i = 0; i < listaProdutos.length; i++) {
    ...
    var desc = card.getElementsByClassName('card-text')[0];
    desc.innerHTML = listaProdutos[i].descricao;

    var valor = card.getElementsByClassName('but')[0];
    valor.innerHTML = listaProdutos[i].valor;
